...
class Currency
{
    public const BASE_URL = 'https://marketdata.tradermade.com';
    public const URI_URL = '/api/v1';
    public const CONVERT_URL = '/convert';
    public const CONVERT_LIVE_URL = '/live';
    public const CURRENCY_LIVE_URL = '/live_currencies_list';
    public const CRYPTO_LIVE_URL = '/live_crypto_list';
    public const API_KEY = 'UAHflQitdZigQKsGR62M';
